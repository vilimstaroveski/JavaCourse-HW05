...
/**
 * Implementation of {@link IComparisonOperator} with function to tell in what relation are 2 {@code String}. This class uses lesser relation.
 * @author Vilim Staroveški
 *
 */
public class Lesser implements IComparisonOperator{
